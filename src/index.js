...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/userService/searchUserService.js", function (e, i, r) {
  ...
  var c = e("function-widget-1:shareDir/context.js").getContext(),
    ...
    a = e("base:widget/libs/jquerypacket.js"),
    t = function (e) {
...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/userService/addFriendService.js", function (e, i, r) {
  "use strict";
  var o = e("function-widget-1:shareDir/context.js").getContext(),
    n = e("base:widget/libs/jquerypacket.js"),
  ...
  c.ADD_FOLLOW = "/mbox/relation/addfollow", c.prototype.addFollow = function () {
    ...
    i = null === e.vcode && null === e.input ? {
      ...
      failCallback: function (i) {
        ...
        if (r.isBan) return !1;
        var n = o.errorMsg(i.errno, "网络错误，请稍候重试"),
          a = !0,
          c = !1;
        if (i && -19 === i.errno) e.isVerifyCode && (e.hasError = !0), e.showVerifyDialog(i.img, i.vcode);
        else {
          if (i) {
            var t = i.errno;
            switch (t) {
...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/userService/createGroupService.js", function (e, r, i) {
  "use strict";
  var a = e("function-widget-1:shareDir/context.js").getContext(),
    n = e("base:widget/libs/jquerypacket.js"),
    ...
    r = null === e.vcode && null === e.input ? e.data : n.extend(e.data, {
      ...
      failCallback: function (r) {
        var i = r.errno,
          n = a.accountBan(i);
        if (n.isBan) return !1;
        var t = a.errorMsg(r.errno, "网络错误，请稍候重试"),
          o = !0,
          c = !1;
...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/shareNameInput.js", function (e, t, a) {
  ...
  n.prototype = {
    render: function () {
      var e = this;
      e.inputWidth = e.el.width() - 20, e.input.css({
        width: e.inputWidth
      }).val(e.inputTips()), e.nameCards.bind("click", function () {
        e.input.focus(), e.el.addClass("focus")
      }), e.input.bind("keyup", function (t) {
        if (59 == t.which || 186 == t.which || 188 == t.which) {
          var a = e.getNameList();
          if (a.length)
            for (var i = 0, n = a.length; n > i; i++) a[i] && e.addCard({
        ...
        if (32 == t.which || 13 == t.which) {
          var a = e.getNameList();
          if (a.length)
            for (var n = 0, s = a.length; s > n; n++) a[n] && e.addCard({
              id: "card-" + parseInt(Math.random() * Math.pow(10, 10) + 1),
              name: a[n]
            })
        }
        return 8 == t.which && "" == e.getNameList()[0] && i(".share-name-item").length > 0 ? (e.removeCard({
          elem: i(".share-name-item").last()
        }), !0) : void 0
      }).bind("blur", function () {
        var t = e.getNameList();
        if (t.length)
          for (var a = 0, n = t.length; n > a; a++) t[a] && e.addCard({
            id: "card-" + parseInt(Math.random() * Math.pow(10, 10) + 1),
            name: t[a]
          });
        ...
        return e.removeCard({
          elem: i(this).closest(".share-name-item")
        }), !0
      })
    },
          ...
          0 == a.errno ? i.each(a.user_list, function (a, s) {
            if (s.wangpan_user)
              if (t.userList[s.uk]) {
                ...
                uk: s.uk,
                name: s.uname
              }, t.userCount += 1, t.getUserList.call(t, t.userList, t.userCount);
            else n.addClass("red"), t.hintShow.call(t, "以下红色显示的不是网盘用户，检查一下吧")
    ...
    addCard: function (e, t) {
      ...
      var s = e.id ? 'id="' + e.id + '"' : "",
        r = e.mail || e.phone ? "(" + (e.mail || e.phone) + ")" : "";
      ...
      if (disk.DEBUG && console.log("t.userCount----------------" + a.userCount + "\n"), "friend" == a.tapType)
        if (a.userCount < 5) {
          if (!t)
            for (var u in a.userList)(a.userList[u].name == e.name || a.userList[u].uk == e.uk) && o(e.name);
...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/groupList.js", function (t, i, e) {
  var s = t("base:widget/libs/jquerypacket.js"),
    ...
    a = t("function-widget-1:shareDir/context.js").getContext(),
    o = function (t) {
  ...
  o.TAG_RECENT = "recent", o.TAG_GROUP = "mboxOfGroup", o.TAG_FRIEND = "mboxOfFriend", o.TIPS_NO_OVER_ONE_CATEGORY = "无法同时选择群主和好友为收件人", o.containerList = [], o.prototype = {
    init: function () {
      for (var t = this, i = 0, e = o.containerList.length; e > i; i++)
        if (o.containerList[i] === t.container || o.containerList[i][0] === t.container[0]) return;
    ...
    loopDealSelectedItem: function (t, i, e, s) {
      var a = t.gid || t.uk,
        ...
        l = this.container.find(r).find("li[data-uniqueId=" + a + "]"),
        d = this.findGroupId(o.TAG_FRIEND);
      if (e === !0) {
        ...
        i === o.TAG_FRIEND && s === !0 && (n.findWhere(this._list[parseInt(d)].list, {
          uk: t.uk
        }) || this._pushFriendData(t)), l.find(".label").addClass("label-on")
    ...
    getFriendGroupId: function () {
      var t = this.findGroupId(o.TAG_FRIEND),
        i = t + "," + this._list[parseInt(t)].list.length;
      return i
    },
    _renderFriendItem: function (t) {
      var i = this.findGroupId(o.TAG_FRIEND),
        e = t.remark || t.priority_name || t.nick_name || t.uname || "未命名",
    ...
    _useTips: function (t, i) {
      if ("boolean" == typeof t) t ? s(".tips", ".share-dialog").show() : s(".tips", ".share-dialog").hide();
      else if (s(".tips", ".share-dialog").show().find("span").html(t), "number" == typeof i) {
        var e = ".share-dialog";
        setTimeout(function () {
          s(".tips", e).hide()
        }, i)
    ...
    _render: function (t, i, e, n, a) {
      var r = this,
        l = this._tagsHash,
        d = "string" == typeof n && "" != n ? n.split(",").length : 0,
        u = d,
        h = "",
        f = i ? n : "";
      ...
      var c = function (e, n, a) {
        u = "string" == typeof n && "" != n ? n.split(",").length : 0, i && d == u || (h += "<ul>"), s.each(e, function (i, e) {
          if (u = "" != n ? n.split(",").length : 0, "string" == typeof e || "number" == typeof e) h += '<li class="step-' + u + '">' + e + "</li>";
...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/shareSelectedList.js", function (e, i, t) {
  var s = e("base:widget/libs/underscore.js"),
    ...
    s = e("base:widget/libs/underscore.js"),
    l = e("function-widget-1:shareDir/context.js").getContext(),
    a = function (e) {
  ...
  a.MAX_SELECTED_GROUP_NUM = 1, a.MAX_SELECTED_FRIEND_NUM = 49, a.singleton = null, a.obtain = function () {
    ...
    event: function () {
      ...
      this.$container.delegate('div[node-type="labelBox"]', "click", function () {
        var i = n(this).closest("li.item"),
          t = i.data("groupid"),
          s = e.iFriendList.findGroup(t);
    ...
    _getItemDom: function () {
      var e = function (e) {
        var i, t = e.length >= 4 ? 4 : e.length,
          s = "";
        if (0 === t) s += '<img src="/box-static/function-widget-1/share/util/img/_nomd5/default-avatar.png" width="27" height="27" />';
        else
          for (var n = 0; t > n; n++) i = e[n], s += '<img src="' + l.tools.baseService.encodeHTML(i.photo) + '" class="img-' + (n + 1) + '"/>';
    ...
    addSelectedItem: function (e, i) {
      ...
      this.$container.find(".none").is(":visible") === !0 && this.$container.find(".none").hide(), s.findWhere(this.dSelectedList, {
        uk: e.uk
      }) || (this.dSelectedList = s.union(this.dSelectedList, [e]), this.$selectedList.append(this._getItemDom(e)), s.size(this.dSelectedList) >= 2 && this._showDefaultTip(), this.iFriendList.loopDealSelectedItem(e, t, !0, i))
    },
  ...
  l.SEARCH_RUL = "/mbox/relation/query", l.prototype = {
    ...
    searchFriend: function (e) {
      ...
      new h({
        query: {
          need_relation: 1,
          user_list: a.stringify([e])
        },
        searchSuccFunc: function (e) {
          t.showSearchUser(e)
        },
    ...
    addFollow: function () {
      var e = this,
        t = {
          member: this._mSearchData,
          whenVerifyCodeDialog: function () {},
    ...
    event: function () {
      ...
      e.elBox.find("#searchFriendLink").bind("click", function () {
        e.$container.html(e.el), s.log.send({
          type: "share_friend_add_link"
        })
        ...
        if (i.hasClass("module-icon-search") === !0) {
          ...
          e.changeSearchIconStatus("toClear"), e.submitFun.call(e, t), s.log.send({
            type: "share_friend_search_friend"
          })
        ...
        e.addFollow(), s.log.send({
          type: "share_friend_add_friend"
        })
        ...
        if (e.iShareSelectedList.iFriendList.onNeedTips(!1), e.iShareSelectedList.isCheckSelectedItemOk(o.TAG_FRIEND) === !0) {
          ...
          var i = e.iShareSelectedList.iFriendList,
            a = i.findGroupId(o.TAG_FRIEND),
            n = function () {
              var s = r.findWhere(i._list[parseInt(a, 10)].list, {
                uk: t.uk
              });
        ...
        s.log.send({
          type: "share_friend_add_receiver"
        })
      })
    },
    initData: function () {
...
define("function-widget-1:shareDir/util/dialogControl/addMember/shareService/service/shareFriend.js", function (e, i, t) {
  var r = e("base:widget/libs/jquerypacket.js"),
    a = e("base:widget/libs/underscore.js"),
    ...
    d = e("function-widget-1:shareDir/context.js").getContext(),
    u = function (e) {
      var i = this;
  ...
  u.operateMaxNum = 500, u.sortByUname = function () {
    ...
    initFriendTabElement: function () {
      ...
      e.el = r('<div id="sharefriendBox" class="share-friend-box"><p class="title"><span id="shareTitle">选择好友分享文件，一次最多50人</span></p><div class="content global-clearfix"><div class="left-side"><div id="contactBox" class="contact-box"><div id="friendBox" class="contact-group"></div><div id="phoneBox" class="contact-group"></div><div id="mailBox" class="contact-group"></div><div id="pimBox" class="pim-box"></div></div></div><div class="right-side"><div id="searchBox" class="search-box"></div><div id="selectedList"></div><!-- 搜索结果 --><div id="resultBox" class="result-box"><div id="searchResultParent" class="search-result-parent"></div></div></div></div></div>'), e.nameContent = e.el.find("#nameContent"), e.shareTitle = e.el.find("#shareTitle"), e.searchBox = e.el.find("#searchBox"), e.friendBox = e.el.find("#friendBox"), e.phoneBox = e.el.find("#phoneBox"), e.mailBox = e.el.find("#mailBox"), e.mBox = e.el.find("#mBox"), e.resultBox = e.el.find("#resultBox"), e.searchResult = e.el.find("#searchResultParent"), e.pimBox = e.el.find("#pimBox"), e.selectedList = e.el.find("#selectedList"), e.selectListData = [], e.descTitle = e.el.find("#descTitle"), e.desc = e.el.find("#desc"), e.descText = "描述一下分享的文件吧", e.descSize = e.desc.prev("label"), e.phoneData = {}, e.mailData = {}, e.mboxRecordsOfRecent = [], e.mboxRecordsOfFriend = [], e.mboxRecordsOfGroup = [], e.tongji = "", e.limit = 50, e.start = 0, e.ajaxUrl = "/inbox/friend/getfriendlist", e.container.html(e.el), e._mShareSelectedList = new o({
        ...
        iShareSelectedList: e._mShareSelectedList
      }), e.searchBox.html(e._mShareFriendSearch.elBox), e.phoneList = new s({
        container: e.phoneBox
      }), e.mailList = new s({
        container: e.mailBox
      }), e.mboxList = new s({
        container: e.mBox
      }), e.resultList = new s({
        container: e.searchResult
      }), e.phoneList.parseTitle = e.mailList.parseTitle = e.mailList.parseTitle = e.resultList.parseTitle = function (e) {
        ...
        var e = function (e) {
          var i, t = e.length >= 4 ? 4 : e.length,
            r = "";
          if (0 === t) r += '<img src="/box-static/function-widget-1/share/util/img/_nomd5/default-avatar.png" width="27" height="27" />';
          else
            for (var a = 0; t > a; a++) i = e[a], r += '<img src="' + i.photo + '" class="img-' + (a + 1) + '"/>';
          return '<div class="img-box img-box-' + t + ' global-clearfix">' + r + "</div>"
        };
        return function (i) {
          if (i.gid) i.title = '<div class="label"></div><div class="uinfo" title="' + d.tools.baseService.encodeHTML(i.name || i.uname || i.dn || "未命名") + '">' + e(i.photoinfo) + d.tools.baseService.encodeHTML(i.name || i.dn || "未命名") + "</div>";
          else if ("string" == typeof i.remark || "string" == typeof i.nick_name || "string" == typeof i.priority_name || "string" == typeof i.uname) {
    ...
    initOtherTabElement: function () {
      ...
      e.el = r('<div id="sharefriendBox" class="share-phone-mail-box"><div class="right-side"><div id="searchBox" class="search-box"></div><div id="contactBox" class="contact-box"><div id="mBox" class="contact-group"></div><div id="friendBox" class="contact-group"></div><div id="phoneBox" class="contact-group"></div><div id="mailBox" class="contact-group"></div><div id="resultBox" class="contact-group"><p class="search-init">搜索结果<span id="searchBack" class="search-back">返回</span></p><div id="searchResult" class="search-result"></div></div><div id="pimBox" class="pim-box"></div></div></div><div class="left-side"><p class="title"><span id="shareTitle">将文件发到好友的收件箱，一次最多5人</span>(<span id="shareNu" class="nu">0</span>)</p><div id="nameContent" class="name-content clearfix"></div><p class="title" id="descTitle">描述：</p><p class="desc-box"><label>0/500</label><textarea id="desc" class="desc" maxlength="500">描述一下分享的文件吧</textarea></p></div></div>'), e.nameContent = e.el.find("#nameContent"), e.shareTitle = e.el.find("#shareTitle"), e.shareNu = e.el.find("#shareNu"), e.searchBox = e.el.find("#searchBox"), e.friendBox = e.el.find("#friendBox"), e.phoneBox = e.el.find("#phoneBox"), e.mailBox = e.el.find("#mailBox"), e.mBox = e.el.find("#mBox"), e.resultBox = e.el.find("#resultBox"), e.searchResult = e.el.find("#searchResult"), e.pimBox = e.el.find("#pimBox"), e.descTitle = e.el.find("#descTitle"), e.desc = e.el.find("#desc"), e.descText = "描述一下分享的文件吧", e.descSize = e.desc.prev("label"), e.phoneData = {}, e.mailData = {}, e.mboxRecords = [], e.tongji = "", e.limit = 50, e.start = 0, e.ajaxUrl = "/inbox/friend/getfriendlist", e._mShareNameInput = new c(e.nameContent, e.tapType), e.container.html(e.el), e.friendList = new s({
        ...
        container: e.searchResult
      }), e.friendList.parseTitle = e.phoneList.parseTitle = e.mailList.parseTitle = e.mailList.parseTitle = e.resultList.parseTitle = function (e) {
        if ("string" == typeof e.uname || "string" == typeof e.dn || "number" == typeof e.uname || "number" == typeof e.dn) {
          var i = e.avatar_url || e.hurl || "/box-static/function-widget-1/share/util/img/_nomd5/default-avatar.png";
      ...
      i = i || "", r.ajax({
        ...
        success: function (n) {
          if (n && 0 == n.errno)
            ...
            } else t.pimBox.html('<span id="pimLink" class="pim-link">' + (1 == e ? "一键导入邮箱联系人" : "一键导入手机联系人") + "</span>");
          else disk.DEBUG && console.log("error : " + n.errno)
        },
        error: function (e) {
          e.errno || console.log("error : " + e)
        }
    ...
    event: function () {
      ...
      e.friendList.onBeforeGroupOpen = function (t, r, a, n) {
        ...
        var t = 28 === i ? 68 : 45;
        e.desc.height(t)
      }, e._mShareNameInput.hintHide = function () {}, e._mShareNameInput.delSign = function () {}, e._mShareNameInput.addSign = function () {}, e._mShareNameInput.getUserList = function (i, t) {
    ...
    shareDataToFriendOrGroup: function () {
      ...
      return function (a) {
        var p, g, v = this,
          x = v._mShareSelectedList.dSelectedList,
          b = v.fileslist;
        ...
        if (p = {
          ...
          }, a.input && a.vcode && (p.vcode = a.vcode, p.input = a.input), this._mShareSelectedList.hasGroupData() === !0) p.send_type = t, p.receiver = r.stringify(s(x)), "BDYGJ" === v.flag && BDHScript.throwEvent("shareStart", {
          gid: p.receiver
        }), r.ajax({
          url: e,
          data: p,
          ...
          success: function (e) {
            if (d.ui.hideTip(), "BDYGJ" === v.flag && BDHScript.throwEvent("shareEnd", {
                ...
                errno: e.errno,
                msg_id: e.msg_id
              }), 0 === e.errno) v.closePanel(), a.closeFun(), m(v.flag);
            else {
              var i = e.errno,
                t = d.accountBan(i);
          ...
          p.send_type = t;
          var T = {
            user_list: r.stringify(c(x))
          };
          a.vcode && a.input && (T = r.extend({}, T, {
            input: a.input,
            vcode: a.vcode
          })), g = new l({
            data: T,
            ...
            addSuccFunc: function (i) {
              p.receiver = r.stringify([i.gid]), d.ui.tip({
                ...
                msg: "正在邀请好友，请稍候...",
                autoClose: !1
              }), "BDYGJ" === v.flag && BDHScript.throwEvent("shareStart", {
                gid: p.receiver
              }), r.ajax({
                url: e,
                data: p,
                ...
                success: function (e) {
                  ...
                  else if (-74 == e.errno || -19 == e.errno) a.paramTips(e);
                  else {
            ...
            addFailFunc: function (e) {
              var i = e.errno,
                t = d.accountBan(i);
              if (t.isBan) return !1;
              var a = d.errorMsg(e.errno, "网络错误，请稍候重试"),
                n = !0,
                o = !1;
              if (e && 2101 === e.errno) a = "你已达到创建2000群上限";
              else if (e && 2100 === e.errno) a = "用户都已经被添加过";
              else if (e && 2119 === e.errno) a = "群成员已满";
              else {
        ...
        } else p.send_type = i, p.receiver = r.stringify(c(x)), p.receiver_name = r.stringify(f(x)), "BDYGJ" === v.flag && BDHScript.throwEvent("shareStart", {
          ukList: p.receiver
        }), r.ajax({
          url: e,
          data: p,
    ...
    shareData: function (e) {
      if (!this.sending()) {
        ...
        var u = {
          receiver: r.stringify(t),
          fs_ids: r.stringify(a),
          send_type: 1,
          msg_type: 2
        };
        e.vcode && e.input && (u.input = e.input, u.vcode = e.vcode), r.ajax({
          ...
          type: "sharePhone",
          val: "手机联系人"
        }), i.tongji = "") : "rimMail" == i.tongji && (s.send({
          type: "shareMail",
          val: "邮箱联系人"
        }), i.tongji = "")
      }
    ...
    _doShareFail: function (e, i) {
      var t = "分享失败，重试一下吧",
        r = this;
      if (-52 == i.errno) t = "发送的文件名中有敏感词，优化一下吧";
      else if (-60 == i.errno) t = "最多只能选5个好友分享";
      else if (-61 == i.errno) t = "你分享的文件数太多了，分批分享吧";
      else if (-62 == i.errno) {
        var a = i.fail_user.length ? i.fail_user.length > 1 ? i.fail_user[0].uname + "等" : i.fail_user[0].uname : "一部分收件人";
        t = a + "的网盘用户校验失败"
      } else if (-63 == i.errno) t = "服务器出错分享失败，重试一下吧";
      else if (-64 == i.errno) t = "服务器出错分享失败，重试一下吧";
      else if (-72 == i.errno) t = "文件不存在，请重新选择文件分享";
      else if (-73 == i.errno) t = "您发送相同文件给相同人频率太快，请等一分钟后发送";
      else if (-75 == i.errno) t = "你今天分享次数太多了，明天再来分享吧";
      else if (-76 == i.errno) t = "你今天分享次数太多了，明天再来分享吧";
      else if (-78 == i.errno) t = "描述中有敏感词，优化一下吧";
      else if (-79 == i.errno) t = "描述不能超过500个字符";
      else if (-80 == i.errno) {
        var a = i.freq_front.length ? i.freq_front.length > 1 ? i.freq_front[0].uname + "等" : i.freq_front[0].uname : "一部分收件人";
        t = "给" + a + "分享次数太多了，明天再来分享吧"
      } else if (-81 == i.errno) t = '绑定手机号码即可以一次分享给多个用户。 <a href="//passport.baidu.com/v2/accountsecurity?act=bindmobile" target="_blank">去绑定手机号</a>';
      else if (-74 == i.errno || -19 == i.errno) e.paramTips(i);
      else if (-88 == i.errno) t = "分享内有敏感词，优化一下吧";
      else {
  ...
  t.prototype = {
    sendAwardTaskRequest: function (e) {
      ...
      if (yunData.TASKKEY && yunData.TASKTIME) return "undefined" == typeof n || n.getItem(e + "_" + FileUtils.sysUID.replace(/@/g, "")) ? !1 : void a.ajax({
        ...
        data: {
          type: i[e],
          sign: yunData.TASKKEY,
          timestamp: yunData.TASKTIME
        },
        success: function (s) {
    ...
    createPublicShare: function (e) {
      if (this.publicInfo = this.onNeedPublicInfo(), this.publicInfo || "undefined" != typeof this.publicShareid) this.publicInfo ? (this.publicLink = this.publicInfo.link, this.publicShareid = this.publicInfo.shareid, e()) : "undefined" != typeof this.publicShareid && e();
      else {
        var i = this,
          s = {
            fid_list: [],
        ...
        s.fid_list = a.stringify(s.fid_list), a.post("/share/set?channel=chunlei&clienttype=0&web=1", s, function (s) {
          if (0 === s.errno) i.publicLink = s.shorturl || s.link, i.publicShareid = s.shareid, e();
          else {
            var t = r().accountBan(s.errno);
            t.isBan && (r().ui.hideTip(), s.errno = t.errno, i.disabledShare = !0, i.shareError = s.errno);
            var a = s.show_msg || r().errorMsg(s.errno, "创建分享失败，请稍后再试");
            i.onNeedTips(a)
          }
        }).error(function () {
    ...
    cancelPublicShare: function () {
      if (!this.publicInfo && this.publicShareid) {
        var e = this,
          i = "[" + this.publicShareid + "]";
        a.post("/share/cancel?channel=chunlei&clienttype=0&web=1", {
          shareid_list: i
    ...
    initShareData: function () {
      var e, i = this.fileslist,
        s = r().tools.baseService,
        t = this,
        n = [],
        c = [],
        h = i.length,
...
define("function-widget-1:share/util/shareFriend/createLinkShare.js", function (e, i, t) {
  ...
  var a = e("base:widget/libs/jquerypacket.js"),
    n = e("function-widget-1:share/context.js").getContext,
    o = e("base:widget/clipboard/myClipboard.js"),
    r = window.yunData;
  s.STATUS_INITIALIZE = 0, s.STATUS_CREATE_PULICE = 1, s.STATUS_CREATE_PRIVATE = 2, s.VALIDITY_INITIALIZE = 7, s.VALIDITY_TEXT_INITIALIZE = "7天", s.prototype = {
    init: function () {
      ...
      this.render(), this.bindEvent(), a(".dialog-share .create").click(function () {
        "public" === e.container.find('.share-method-line input[type="radio"]:checked').val() ? (e.status = s.STATUS_CREATE_PULICE, e.createShareLink(function () {
          e.container.find(".create-link").attr("class", "create-link public-link has-create"), a(".dialog-share .create").hide(), a(".dialog-share .close .text").text("关闭"), a("#copyShare").next(".copy-tips").hide(), a(".share-validity-tip").css("right", "115px"), a(".open-share-warning").hide(), a(".ogc-tips").hide(), n().log.send({
    ...
    createCallBack: function (e, i, t) {
      ...
      if ("string" == typeof e && (e = a.parseJSON(e)), n().ui.hideTip(), 0 === e.errno) {
        ...
        var l = e.show_msg || n().errorMsg(e.errno, "请求发生错误，请稍后再试");
    ...
    getQRCode: function (e, i) {
      var t = this,
        s = a("#share .QR-code .loading"),
        o = a("#share .QR-code .failure"),
        r = a("#share .QR-code .success"),
        c = a("#share .QR-code .down-btn");
    ...
    setClipboard: function () {
      ...
      e.status === s.STATUS_CREATE_PRIVATE && (i = "链接: " + i + " 提取码: " + a(".share-password", e.container).val()), i += e.createsharetipsLdlj, e.myClipboard || (e.myClipboard = new o(a("#copyShare"))), e.myClipboard.setText(i), e.myClipboard.on("success", function () {
        ...
        n().ui.tip({
          mode: "caution",
          msg: "您的浏览器不支持自动复制，请选中链接后点击右键进行复制。",
          autoClose: !1,
          hasClose: !0
        })
      })
...
define("function-widget-1:guide/util/promo/activity/couponText.js", function (i, s, o) {
  ...
  var e = i("system-core:system/uiService/canvas/canvas.js"),
    t = i("base:widget/libs/jquerypacket.js"),
    a = t("body"),
    c = [function (i) {
...
define("function-widget-1:guide/util/promo/activity/vipCoupon.js", function (e, t, o) {
  ...
  var n = e("base:widget/libs/jquerypacket.js"),
    s = e("function-widget-1:guide/util/promo/activity/couponText.js"),
    a = e("base:widget/storage/storage.js"),
    c = e("function-widget-1:guide/context.js").getContext,
    l = window.yunData,
    r = {},
    u = +l.CURRACTIVITYCODE,
    g = 1e3 * +l.activity_end_time,
  ...
  9 === u ? r = {
    ...
    width: 288,
    height: 130,
    backgroundImage: "url(/box-static/function-widget-1/guide/util/promo/img/christmas_2017_050cb96.png)"
  } : 10 === u ? r = {
    flag: "svip_present",
    title: "超级会员满赠活动",
    ...
    width: 216,
    height: 126,
    backgroundImage: "url(/box-static/function-widget-1/guide/util/promo/img/lottery-showlove_5c34162.png)"
  });
  ...
  o.exports = {
    ...
    clickCallback: function () {
      ...
      if ("coupon_consume" === r.flag) n.ajax({
        ...
        type: "disk_home_coupon_consume_click"
      });
      else if ("svip_present" === r.flag) {
      ...
      var o = o || {},
        ...
        n = {
          ...
          setFocusIndex: function (o, i) {
            ...
            t(s.moduleFocusUl).animate({
              left: -c * o
            }, 500), "function" == typeof i && i(o)
          },
          ...
          animate1: function () {
            t(s.userAblityShow1).find(".animate").removeClass("animate"), setTimeout(function () {
              ...
              var o = t(s.userAblityShow1).find(".img-slide-left")[0],
                e = t(s.userAblityShow1).find(".click")[0];
...
define("function-widget-1:guide/util/marchActivityTip/marchActivityTip.js", function (t, e, i) {
  var n = t("base:widget/libs/jquerypacket.js"),
    o = t("base:widget/storage/storage.js"),
    c = t("function-widget-1:guide/context.js").getContext,
    a = o.getItem("sendMonthlyTipUserType"),
    s = "";
  ...
  var r = s + '<div class="marchActivityTip-close"></div></div>',
    d = {
      showTip: function () {
        n("body").append(r), d.setStorage(), c().log.send({
          type: "web_send_monthly_tip_open_" + a,
          platform: "web"
        })
      },
      bindEvent: function () {
        n(".march-activity-common").click(function () {
          ...
          c().log.send({
            type: "web_send_monthly_tip_close_" + a,
            platform: "web"
          }), d.delTip()
        })
      },
...
define("function-widget-1:guide/util/openFileTip/openFileTip.js", function (e, o, i) {
  ...
  var n = e("base:widget/libs/underscore.js"),
    ...
    d = e("function-widget-1:guide/context.js").getContext,
    a = "flag_show_functions_",
    f = [{
      category: [".mm", ".xmind", ".mmap"],
      message: "单击即可查看思维导图，免去下载烦恼~"
    }, {
      category: [".dxf", ".dwt", ".dwg", ".dws"],
      message: "单击即可查看CAD，免去下载烦恼~"
    }, {
      category: [".zip", ".rar"],
  ...
  i.exports.show = function () {
    ...
    if (null !== o) {
      var i = o.fileExt,
        r = n.filter(f, function (e) {
          return n.indexOf(e.category, i) > -1
        })[0];
      if (r) {
        var d = r.message,
          c = a + r.category.join("_");
        l.showBubbleTip({
          message: d,
          left: o.left,
          top: o.top,
...
define("function-widget-1:guide/util/picNewTip/picNewTip.js", function (e, i, c) {
  var o = e("base:widget/libs/jquerypacket.js"),
    l = e("function-widget-1:guide/context.js").getContext;
  c.exports.show = function () {
    o("body").prepend('<div class="welcome-mask"></div><div class="welcome-box">    <div class="welcome-bg">        <div class="welcome-pic"></div>        <div class="welcome-word"></div>        <div class="welcome-begin"></div>    </div>    <div class="welcome-close"></div></div>'), o(".welcome-begin").on("click", function () {
      window.location.href = "/disk/timeline", l().log.send({
        type: "picNew_guide_close"
      })
...
define("function-widget-1:guide/util/cardHolder/cardHolderKeyImport/cardHolderKeyImport.js", function (e, t, n) {
  ...
  n.exports.show = function (e, t) {
    o().message.callPlugin("一键导入证件@com.baidu.pan", {
      manual: !1,
      data: t
    })
  }
...
define("function-widget-1:guide/util/cardHolder/cardHolderGiveSpace/cardHolderGiveSpace.js", function (e, d, c) {
  ...
  var i = e("base:widget/libs/jquerypacket.js"),
    s = window.yunData,
    r = e("function-widget-1:guide/context.js").getContext,
    n = e("base:widget/storage/storage.js");
...
define("function-widget-1:guide/util/promo/promo.js", function (a, e, s) {
  "use strict";
  var c = a("base:widget/libs/jquerypacket.js"),
    o = a("function-widget-1:guide/util/promo/activity/vipCoupon.js");
...
define("function-widget-1:guide/util/directorTip/directorTip.js", function (e, t, o) {
  var n = e("base:widget/libs/jquerypacket.js"),
    ...
    r = e("function-widget-1:guide/context.js").getContext,
    a = window.yunData,
    c = a.MYNAME + "_director_guide",
    s = !1,
    d = {
      node: {
        panel: 'div[node-type="directorTip-panel"]',
        close: 'em[node-type="directorTip-close"]'
      },
      api: {
      ...
      bindEvents: function () {
        n(d.node.close).on("click", function () {
          d.hide(), d.conf.hasTips = !1, i.setItem(c, 1)
        })
      },
      hide: function () {
  ...
  o.exports.show = function () {
    if (r() && r().Broker && r().Broker.getButtonBroker) {
      var e = r().Broker.getButtonBroker("listTools");
      if (!e) return;
      e.on("filesSelect", function (e) {
        if (1 === e.length) {
          d.init();
...
define("function-widget-1:guide/util/enterpriseTip/enterpriseTip.js", function (e, t, n) {
  ...
  var i = e("base:widget/libs/jquerypacket.js"),
    s = e("base:widget/storage/storage.js"),
    r = e("function-widget-1:guide/context.js"),
    a = r.getContext,
    o = window.yunData,
    p = "/api/userflag",
    ...
    u = {
      buildTip: function () {
        ...
        }), e.toolbar.prevDom(t, 2), e.log.send({
          type: "enterpriseTip_shareAccount"
        }), e.log.sendBaiduLog("企业版共享帐号引导", "企业版共享帐号引导展现")
      },
      checkServer: function () {
        var e, t = s.getItem("getServerUserFlagApi"),
          n = 0;
        return t && (e = +t.split("_")[0], n = +t.split("_")[1]), {
          localWeek: e,
          isShow: n
        }
      }
...
define("function-widget-1:guide/util/trialVipTip/trialVipTip.js", function (i, s, a) {
  var e = i("base:widget/libs/jquerypacket.js"),
    t = i("system-core:system/uiService/canvas/canvas.js");
  a.exports.show = function (i) {
    var s = i ? i.isVip : !1,
      a = "fail",
      n = '<span class="btn btn-fail"></span>';
    ...
    e(document.body).append(c), t.addAnimate({
      opacity: .7
    }).show(), c.find(".btn").click(function () {
      c.remove(), t.hide()
    })
  }
});;
...
define("function-widget-1:guide/util/shareDirTip/shareDirRootChange.js", function (t, e, i) {
  function o() {
    ...
    if (0 === t.list.getCurrentList().length) {
      var e = t.ui.cacheManage.getCache().list,
        i = t.tools.topMountManager.FILE_IDENTITY.SHARE;
  ...
  function n(t) {
    for (var e = t.length, i = t[0].filename, n = 0, a = /[\u4E00-\u9FA5]/, r = 0; r < i.length; r++)
      if (a.test(i[r]) ? n += 2 : n++, n > 40) {
        i = i.substr(0, r) + "...";
        break
      } var g = "";
  ...
  var s = t("function-widget-1:guide/context.js").getContext,
    a = window.yunData;
...
define("function-widget-1:guide/util/shareDirTip/setShareDismiss.js", function (t, e, i) {
  function s(t) {
    for (var e = 0, i = 0; i < t.length; i++)
      if (o.test(t[i]) ? e += 2 : e++, e > 40) return t.substr(0, i) + "...";
    return t
  }
  var n = t("function-widget-1:guide/context.js").getContext,
    o = /[\u4E00-\u9FA5]/;
  i.exports.show = function () {
    var t = n(),
      e = t.router.query.get("path"),
      i = s(e.substr(e.lastIndexOf("/") + 1)),
      o = t.ui.window({
        title: "文件夹已被取消共享",
        lock: !0,
        close: !0,
...
define("function-widget-1:guide/util/capacityUpdateTip/capacityUpdateTip.js", function (t, a, e) {
  var i = t("base:widget/libs/jquerypacket.js"),
    c = t("function-widget-1:guide/context.js").getContext,
    p = t("base:widget/storage/storage.js"),
    o = window.yunData || {};
  e.exports.show = function () {
    var t = o.volAutoup,
      a = "capacity_update_uk_" + o.MYUK,
      e = function (t) {
    ...
    i("body").prepend('<div class="capacity-update-mask"></div><div class="capacity-update-box">    <div class="capacity-update-close"></div>    <div class="capacity-update-quota">        <span class="quota-text"></span>        <span class="quota-result"></span>    </div>    <div class="capacity-update-begin">去看看</div></div>'), i(".quota-result").text(e(t)), i(".capacity-update-begin").on("click", function () {
      window.location.href = "/buy/center?tag=3&from=homepage#/personalcenter/2", p.setItem(a, !0), c().log.send({
        type: "capacity_update_dialog_tosee_" + d
      })
    }), i(".capacity-update-close").on("click", function () {
      i(".capacity-update-box").remove(), i(".capacity-update-mask").remove(), p.setItem(a, !0), c().log.send({
        type: "capacity_update_dialog_close_" + d
      })
    }), c().log.send({
      type: "capacity_update_dialog_appear_" + d
    })
  }
});;
define("function-widget-1:download/util/interactionUtil.js", function (i, a, s) {
  function e() {
    var i = [];
    return i.push('<div class="module-download-dialog">'), i.push('<div class="content">'), i.push('<div id="' + w._mMsgId + '_videoGuideBox" class="videoGuide">'), i.push('<div class="guideHeader"></div>'), i.push('<div class="guidePreview"></div>'), i.push("</div>"), i.push('<div id="' + w._mMsgId + '" class="message global-center">加载中&hellip;</div>'), i.push('<div id="' + w._mClientHintId + '" class="g-clearfix download-manage-client-hint g-center"></div>'), i.push('<div class="dlg-ft">'), i.push('<div class="g-clearfix g-center">'), i.push('<div class="videoBtnBox">'), i.push('<a href="javascript:void(0);" id="' + w._mPositiveVideoId + '" class="g-button g-button-large g-button-blue-large">'), i.push('<span class="g-button-right">'), i.push('<span class="text">' + (yunData.ISSVIP && 1 === +yunData.ISSVIP ? '<em class="d-svip-icon"></em>超级会员极速下载' : 1 === +yunData.ISVIP ? '<em class="d-vip-icon"></em>会员高速下载' : "高速下载（推荐）") + "</span>"), i.push("</span>"), i.push("</a>"), i.push('<a href="javascript:;" id="' + w._mNegativeVideoId + '" class="g-button g-button-large g-button-gray-large">'), i.push('<span class="g-button-right">普通下载</span>'), i.push('<i class="lineheight-ie7"></i>'), i.push("</a>"), i.push("</div>"), i.push('<div class="normalBtnBox">'), i.push('<a href="javascript:;" id="' + w._mPositiveId + '" node-type="download-speedup" class="g-button g-button-large g-button-blue-large">'), i.push('<span class="g-button-right">'), i.push('<span class="text">' + (yunData.ISSVIP && 1 === +yunData.ISSVIP ? '<em class="d-svip-icon"></em>超级会员极速下载' : 1 === +yunData.ISVIP ? '<em class="d-vip-icon"></em>会员高速下载' : "高速下载（推荐）") + "</span>"), i.push("</span>"), i.push("</a>"), _ && (i.push('<a href="javascript:void(0);" id="' + w._mPositiveId2 + '" node-type="download-speedup" class="g-button g-button-large g-button-blue-large"> '), i.push('<span class="g-button-right"><span class="text">下载Linux版（deb格式）</span></span></span></a>')), i.push('<a href="javascript:;"  id="' + w._mNegativeId + '" node-type="download-normal" class="g-button g-button-large g-button-gray-large">'), i.push('<span class="g-button-right">'), i.push('<span class="text">普通下载</span>'), i.push("</span>"), i.push("</a>"), i.push("</div>"), i.push("</div>"), i.push("</div>"), i.push("</div>"), i.push('<div class="dlg-ft01 b-rlv" id="show-acceleration-pack">'), i.push('<div class="g-clearfix center acceleration-pack">'), i.push('<span class="dowmload-imgs-style dowmload-imgs-style01"></span>'), i.push('<span class="dowmload-content-style">还想更快？购买网络加速包，最高</span>'), i.push('<span class="download-upspeed-style">提速40%</span>'), i.push('        <a href="javascript:;" id="goToBuy" class="g-button-small g-button abtn download-change-link-style">'), i.push('            <b class="g-button-right">立即提速</b>'), i.push("        </a>"), i.push("</div>"), i.push("</div>"), i.push('<div class="dlg-ft01 b-rlv" id="show-buyvip-pack" style="display:none;">'), i.push('    <div class="g-clearfix center buyvip-pack">'), i.push('        <span class="dowmload-imgs-style dowmload-imgs-style01"></span>'), i.push('        <span class="dowmload-content-style">开通百度网盘超级会员，专享极速下载特权</span>'), i.push('        <a href="javascript:;" id="goToBuyVip" class="g-button-small g-button abtn download-change-link-style">'), i.push('            <b class="g-button-right">立即提速</b>'), i.push("        </a>"), i.push("    </div>"), i.push("</div>"), i.join("")
  }

  function t(i) {
    var a = "/rest/2.0/membership/isp?method=query";
    1 === yunData.LOGINSTATUS && (y.isVideo || I.ajax({
      url: a,
      type: "POST",
      data: {
        user_id: 1
  ...
  function o() {
    var i = w.packName;
    return y.isNormalSingleFile ? y.list[0].server_filename : 1 === y.list.length ? i : i + "等（<strong>" + y.list.length + "</strong>）个文件"
  }

  function n(i) {
    var a, s, e, t, d = "",
      n = m().file.getIconAndPlugin,
      l = "";
    i === !0 ? (w.dialog.$dialog.find(".dialog-header-title").text("高速下载"), y.isVideo ? d += '<p class="download-mgr-dialog-title"></p>' : d = '<p class="download-mgr-dialog-icon"></p><p class="download-mgr-dialog-title">百度网盘客户端</p>', d += '<p class="download-mgr-dialog-text">快速、稳定下载大文件，请使用百度网盘客户端下载，还支持断点续传哟~</p>') : (d = '<span class="fileicon"></span>' + o(), l = o()), I("#" + w._mMsgId).attr({
      title: l
    }).html(d), t = I(".fileicon", "#" + w._mMsgId), b[r.INDEX_OF_FILENUM] !== r.FILE_NUM_SINGLE ? (e = y.list[0], a = m().file.getIconAndPlugin(e.path, 1, !0, !1, e.share).smallIcon) : (e = y.list instanceof Array ? y.list[0] : y.list, 1 === e.isdir ? a = n(e.path, 1, !1, !1, e.share).smallIcon : (s = e.path, a = n(s, 0).smallIcon)), t.addClass(a), t.css("margin-right", "8px")
  }

  function l() {
    var i = b[r.INDEX_OF_FILESIZE] === r.FILE_SIZE_MORE_LIMIT,
      a = I("#" + w._mMsgId + "_videoGuideBox"),
      s = a.find(".guideHeader"),
      e = a.find(".guidePreview"),
      t = y.list[0],
      d = !1,
      o = I("#" + w._mPositiveVideoId).parent(),
      l = I("#" + w._mPositiveId).parent();
    I("span", "#" + w._mNegativeVideoId).text("普通下载"), I(".g-button-right span", "#" + w._mPositiveVideoId).html(yunData.ISSVIP && 1 === +yunData.ISSVIP ? '<em class="d-svip-icon"></em>超级会员极速下载' : 1 === +yunData.ISVIP ? '<em class="d-vip-icon"></em>会员高速下载' : "高速下载（推荐）"), I("#" + w._mPositiveVideoId).attr("href", "javascript:;").css("display", ""), I("#" + w._mPositiveId).parent().hide(), i ? (w.videoGuideText = "你下载的文件过大，请使用百度网盘客户端或点击预览在线观看", I("#" + w._mNegativeVideoId).css("display", "none")) : (w.videoGuideText = "点击立即播放，无需下载即可在线观看视频", I("#" + w._mNegativeVideoId).css("display", ""));
    var p = I('<a target="_blank" class="playLink" href="/play/video#/video?path=' + encodeURIComponent(t.path) + '&t=-1"><div class="playBox"><i title="播放" class="playIcon"></i><span class="playText">点击播放</span></div></a>'),
      g = "";
    t.thumbs && t.thumbs.url2 && (g = t.thumbs.url2), e.html(p).attr("style", "background:url(" + g + ") 50% 50% no-repeat").show(), i ? s.html("<span>" + w.videoGuideText + "</span></div>").show() : s.html('<div class="decorLine"></div><span>' + w.videoGuideText + '</span><div class="decorLine lineR"></div>').show(), w.fromVideoCall ? (I(".text", "#" + w._mPositiveVideoId).text("安装最新版网盘客户端"), I("#" + w._mNegativeVideoId).css("display", "none"), d = !0) : (m().log.send({
      page: v.getDownloadLogmsg(),
      url: "//pan.baidu.com/api/analytics",
      type: "video_download_guide_window_" + (i ? "1" : "0")
    }), !i && m().log.send({
      type: y.logMsg.category + "-" + y.logMsg.actionRecommendPlugin
    })), "postInstall" === w.mode ? (o.hide(), l.show()) : (o.show(), l.hide()), n(d)
  }

  function p(i) {
    i ? (I("#" + w._mMsgId + "_videoGuideBox").show(), I("#" + w._mPositiveVideoId).parent().show()) : (I("#" + w._mMsgId + "_videoGuideBox").hide(), I("#" + w._mPositiveVideoId).parent().hide())
  }

  function g(i, a) {
    c(i, a), w.dialog && I("div.chromeUpgradeHelpTip", w.dialog.$dialog).remove(), p(y.isVideo), y.isVideo ? l() : (I("#" + w._mPositiveId).parent().show(), f[w.mode]())
  }

  function u() {
    w.dialog = m().ui.window({
      id: w.DIALOG_ID,
      title: "文件下载",
      body: e(),
      width: "568px"
    }), w.guanjiaDownloadUrl || h.getGuanjiaDownloadUrl(function (i) {
      w.guanjiaDownloadUrl = i.url, w.guanjiaVersion = i.version
    }), t(function (i) {
      i.isp_name && "" !== i.isp_name && 1 === +yunData.ISSVIP ? (w._mIspName = i.isp_name, I("#show-acceleration-pack").fadeIn("200"), m().log.send({
        page: v.getDownloadLogmsg(),
        url: "//pan.baidu.com/api/analytics",
        type: "check_isp_name"
      })) : d()
  ...
  function c(i, a) {
    b = i, y = a, w.packName = y.packName, w.mode = y.mode
  }
  var m = i("function-widget-1:download/util/context.js").getContext,
    I = i("base:widget/libs/jquerypacket.js"),
    ...
    v = i("function-widget-1:download/util/downloadCommonUtil.js"),
    _ = String(navigator.platform).indexOf("Linux") > -1,
    w = {
      _mMsgId: disk.obtainId(),
      _mPositiveId: disk.obtainId(),
      _mPositiveId2: disk.obtainId(),
    ...
    f = {
      preDownload: function () {
        w._mIspName && 1 === +yunData.ISSVIP ? I("#show-acceleration-pack").fadeIn("200") : 1 !== +yunData.ISSVIP && d(), I("#" + w._mClientHintId).css("display", "none"), I("#" + w._mMsgId).removeClass("download-mgr-tight"), n(), I(".g-button-right span", "#" + w._mPositiveId).html(yunData.ISSVIP && 1 === +yunData.ISSVIP ? '<em class="d-svip-icon"></em>超级会员极速下载' : 1 === +yunData.ISVIP ? '<em class="d-vip-icon"></em>会员高速下载' : "高速下载（推荐）"), I("#" + w._mPositiveId).attr("href", "javascript:;").css("display", ""), I(".g-button-right", "#" + w._mNegativeId).text("普通下载"), I("#" + w._mNegativeId).css("display", ""), w.dialog.$dialog.find(".dialog-header-title").text("文件下载"), m().log.send({
          type: y.logMsg.category + "-" + y.logMsg.actionRecommendPlugin
        }), w.dialog.show()
      },
      preInstall: function () {
        var i = !0;
        I("#" + w._mMsgId).addClass("download-mgr-tight"), I("#" + w._mPositiveId).css("display", ""), I("#" + w._mPositiveId2).css("display", ""), I("#" + w._mPositiveVideoId).css("display", ""), I(".text", "#" + w._mPositiveId).text(_ ? "下载Linux版（rpm格式）" : "安装最新版网盘客户端"), I(".text", "#" + w._mPositiveVideoId).text("安装最新版网盘客户端"), I("#" + w._mPositiveId).attr("href", "javascript:;"), I("#" + w._mPositiveVideoId).attr("href", "javascript:;"), I("#" + w._mNegativeId).css("display", "none"), I("#" + w._mNegativeVideoId).css("display", "none"), I("#" + w._mDownloadTipsId).css("display", "none"), I("#" + w._mClientHintId).css("display", "none"), w.dialog.$dialog.find(".dialog-header-title").text("文件下载"), r[r.INDEX_OF_FILENUM] === r.FILE_NUM_SINGLE ? b[r.INDEX_OF_FILESIZE] === r.FILE_SIZE_MORE_LIMIT ? (I("#" + w._mClientHintId).html("你下载的文件过大，请使用百度网盘客户端。").show(), i = !1) : (I("#show-acceleration-pack").hide(), I("#show-buyvip-pack").hide(), I("#" + w._mClientHintId).html("").hide()) : r[r.INDEX_OF_FILENUM] !== r.FILE_NUM_SINGLE ? ((b[r.INDEX_OF_FILESIZE] === r.FILE_SIZE_MORE_LIMIT || b[r.INDEX_OF_FILENUM] === r.FILE_NUM_MORE_100) && (I("#" + w._mClientHintId).html("你下载的文件过大或者过多，请使用百度网盘客户端下载。").show(), i = !1), b[r.INDEX_OF_ISDIR] === r.FILE_HASDIR ? (I("#" + w._mClientHintId).html("你下载的内容包含文件夹，请使用百度网盘客户端下载。").show(), i = !1) : I("#" + w._mClientHintId).html("").hide()) : I("#" + w._mClientHintId).html("").hide(), n(i), w.dialog.hide(), w.isVideoShow = !1
      },
      postInstall: function (i) {
        "string" == typeof i && (w.guanjiaDownloadUrl = i), _ ? (I("#" + w._mPositiveId).attr("href", w.guanjiaDownloadUrl[0]), I("#" + w._mPositiveId2).attr("href", w.guanjiaDownloadUrl[1])) : I("#" + w._mPositiveId).attr("href", w.guanjiaDownloadUrl), I("#" + w._mPositiveVideoId).attr("href", w.guanjiaDownloadUrl), I("#" + w._mClientHintId).css("display", "none"), I("#" + w._mMsgId).removeClass("download-mgr-tight").html("<p>安装完成后，重启浏览器即可高速下载</p>"), I("#" + w._mPositiveId).css("display", "none"), I("#" + w._mPositiveId2).css("display", "none"), I("#" + w._mPositiveVideoId).css("display", "none"), I("#" + w._mNegativeId).css("display", ""), I("#" + w._mNegativeVideoId).css("display", ""), I("span", "#" + w._mNegativeId).text("知道了"), I("span", "#" + w._mNegativeVideoId).text("知道了"), I("#" + w._mNegativeId).show(), I("#" + w._mPositiveVideoId).parent().hide(), I("#" + w._mPositiveId).parent().show(), w.dialog.show(), y.isVideo && m().log.send({
          page: v.getDownloadLogmsg(),
          url: "//pan.baidu.com/api/analytics",
...
define("function-widget-1:download/service/guanjiaServerProxy.js", function (e, n, o) {
  var r = (e("function-widget-1:download/util/downloadCommonUtil.js"), e("base:widget/libs/jquerypacket.js")),
    t = e("base:widget/storage/storage.js"),
    ...
    i = {
      ...
      sendDataByServer: function (e, n, o) {
        r.ajax({
          ...
          dataType: "json",
          success: function (e) {
            "function" == typeof o && o(e), s().log.send({
...
define("function-widget-1:download/service/guanjiaConnector.js", function (o, e, n) {
  var t = o("function-widget-1:download/util/downloadCommonUtil.js"),
    i = o("base:widget/libs/jquerypacket.js"),
    c = o("base:widget/httpProxy/httpProxy.js"),
    a = o("base:widget/tools/tools.js"),
    r = o("function-widget-1:download/util/context.js").getContext,
    l = {
      conf: {
      ...
      setVersion: function (o) {
        l.conf.guanjiaVersion = o, "http:" !== location.protocol || t.isPlatformWindows() && !t.compareVersion(o, "5.4.7") || l.imageAccess("https://" + location.host + "/yun-static/common/images/default.gif", function () {
      ...
      util: {
        init: function (o) {
          l.conf.checkStartTime = o ? +new Date : 0, l.util.checkLocalServer(), t.getChromeVersion() <= 42 && setTimeout(function () {
            l.util.localServerReady || l.util.installHook()
          }, 1e3)
        },
        checkLtIe8: function () {
          var o = i.browser || {};
        ...
        checkLocalServer: function () {
          if (!l.conf.localServerReady)
            for (var o = 0, e = function (e) {
                var n = l.conf.localUrl + ":" + e + "/guanjia",
                  a = {
                    url: n,
                    type: "GET",
                    data: {
                    ...
                    success: function (o) {
                      ...
                      if (o && o.version) {
                        if (t.isPlatformWindows() && !t.compareVersion(o.version, l.conf.minVersion)) return;
                        l.conf.currentPort = e, l.setVersion(o.version), l.conf.localServerReady = !0
                      }
                    },
                    error: function () {
                      o++, o === l.conf.portPollLimit && +new Date - l.conf.checkStartTime < 3e3 && setTimeout(function () {
                        l.util.checkLocalServer()
                      }, 400)
                    }
                  };
                location.protocol.indexOf("https") > -1 || l.util.checkLtIe8() ? t.isPlatformMac() ? l.imageAccess(l.conf.localUrl + ":" + e + "/version.png", function () {
                  c.ajax(a)
                }, a.error) : c.ajax(a) : i.ajax(a)
              }, n = 0; n < l.conf.portPollLimit; n++) e(l.conf.localPort + n)
        },
        installHook: function () {
          var o, e, n = [];
          return null !== l.conf.hook ? l.conf.hook : (o = document.getElementById(l.conf.domIframeId), o && document.body.removeChild(o), o = document.createElement("div"), o.style.width = "1px", o.style.height = "1px", o.style.position = "absolute", o.style.overflow = "hidden", o.style.left = "-999em", o.style.top = "-999em", o.id = l.conf.domIframeId, document.body.appendChild(o), n.push("undefined" != typeof window.attachEvent || window.ActiveXObject || "ActiveXObject" in window ? '<object id="' + l.conf.domHookId + '" classid="CLSID:8DCE7B6C-C3B9-4efd-9CC6-2D9F938B4A06" hidden="true" viewastext></OBJECT>' : -1 !== navigator.userAgent.indexOf("Trident/7.0") ? '<embed id="' + l.conf.domHookId + '" type="application/bd-npYunWebDetect-plugin" width="0" height="0">' : '<embed id="' + l.conf.domHookId + '" type="application/bd-npYunWebDetect-plugin" width="0" height="0">'), o.innerHTML = n.join(""), e = l.util.hasPlugin(), e && (l.conf.hook = document.getElementById(l.conf.domHookId), l.setVersion(l.conf.hook.GetVersion())), l.conf.hook)
        },
        hasPlugin: function () {
          var o = null;
          try {
        ...
        checkPluginHook: function () {
          return l.conf.installHook()
        },
        sendData: function (o, e, n, a, u) {
          if (l.conf.localServerReady) {
            var s = l.conf.localUrl + ":" + l.conf.currentPort + "/guanjia?";
            s += "method=" + o + "&uk=" + n + "&checkuser=" + (a ? 1 : 0);
            var f = {
              url: s,
              type: "POST",
              data: {
              ...
              success: function () {
                r().log.send({
                  type: "call_guanjia_local_success"
                })
              },
              timeout: 3e3,
              error: function () {
                r().log.send({
                  type: "call_guanjia_local_fail"
                }), u || t.openYunGuanjiaByScheme("baiduyunguanjia://guanjia", function () {
                  l.conf.localServerReady = !1, l.util.init(!0), setTimeout(function () {
                    l.util.sendData(o, e, n, a, !0)
                  }, 3e3)
                })
              }
            };
            location.protocol.indexOf("https") > -1 || l.util.checkLtIe8() ? c.ajax(f) : i.ajax(f)
          } else {
            if (!l.conf.hook) return -2;
            try {
              "undefined" == typeof a ? l.conf.hook[o](e, n) : l.conf.hook[o](e, n, a)
            } catch (d) {
              return -2
            }
          }
  ...
  l.setVersion(0), n.exports = {
    getVersion: function () {
      return l.conf.guanjiaVersion
    },
    checkConnect: function () {
      return l.conf.localServerReady ? !0 : t.isChromeAndGreaterThan42() ? !1 : l.conf.hook && l.conf.guanjiaVersion
    },
...
define("function-widget-1:download/util/downloadGuanjiaUtil.js", function (i, n, e) {
  var t = i("function-widget-1:download/util/context.js").getContext,
    s = i("function-widget-1:download/util/downloadCommonUtil.js"),
    u = String(navigator.platform).indexOf("Linux") > -1;
  e.exports = {
    getFormatedLinkList: function (i, n) {
      for (var e = {}, t = null, s = 0; s < n.length; s++) e[n[s].fs_id] = n[s].dlink;
      for (var u = 0; u < i.length; u++) t = i[u].fs_id, i[u].link = e[t];
      return i
    },
    doError: function (i) {
      var n = navigator.userAgent.toLowerCase(),
        e = "启动百度网盘客户端失败，请安装最新版本";
      /x64/g.test(n) === !0 && /msie\s[678]/i.test(n) === !0 ? e = "加速下载暂不支持64位浏览器，请换个浏览器试试" : n.indexOf("se 2.x") > -1 ? e = "无法启动百度网盘客户端，请换个浏览器试试" : n.indexOf("360se") > -1 ? e = "无法启动百度网盘客户端，请换个浏览器试试" : void 0 === i ? e = "插件已被禁用，请查看浏览器插件设置" : -2 == i ? e = "启动百度网盘客户端失败，请重启浏览器后重试" : -4 == i && (e = "检测到百度网盘客户端已卸载，请重新安装后重试"), t().ui.tip({
        mode: "caution",
        msg: e
      })
    },
    getGuanjiaDownloadUrl: function (i) {
      var n = {
          url: "",
          version: ""
        },
        e = "5.4.4";
      $.ajax({
        url: "/api/getconfig?type=fetch&keys={%22linux_download_url_settings%22:0}",
        type: "GET",
        dataType: "JSON",
        cache: !1,
        success: function (t) {
          var a, o;
          if (0 === t.errno)
            if (t.list.length) try {
              a = $.parseJSON(t.list[0]), o = a.version;
              var d = $.parseJSON(a.value);
              n.url = s.isPlatformMac() ? d["client-mac"] : u ? [d["client-linux1"], d["client-linux2"]] : d["client-guanjia"], n.version = o
            } catch (r) {
              n.version = e
            } else n.version = e;
            else n.version = e;
          n.url = n.url || "http://issuecdn.baidupcs.com/issue/netdisk/yunguanjia/BaiduYunGuanjia_5.4.4.exe", "function" == typeof i && i(n)
        },
        error: function () {
          s.isPlatformMac() ? (n.url = "http://issuecdn.baidupcs.com/issue/netdisk/MACguanjia/BaiduNetdisk_mac_3.0.5.4.dmg", n.version = "3.0.5") : u ? (n.url = ["http://issuecdn.baidupcs.com/issue/netdisk/LinuxGuanjia/3.0.1/baidunetdisk_linux_3.0.1.2.rpm", "http://issuecdn.baidupcs.com/issue/netdisk/LinuxGuanjia/3.0.1/baidunetdisk_linux_3.0.1.2.deb"], n.version = "3.0.1") : (n.url = "http://issuecdn.baidupcs.com/issue/netdisk/yunguanjia/BaiduYunGuanjia_5.4.4.exe", n.version = e), "function" == typeof i && i(n)
        }
      })
    }
  }
...
define("function-widget-1:download/config.js", function (_, E, I) {
  var L = {
    ...
    U = [
      ...
      ["01", "012", "0", "0", "01", "2", "01"],
      ["01", "012", "0", "0", "01", "012", "1"],
      ["01", "012", "2", "01", "01", "012", "01"],
      ["01", "012", "1", "01", "1", "012", "01"],
      ["01", "012", "1", "01", "01", "2", "01"]
    ],
    d = [
      ["01", "012", "0", "0", "0", "1", "0"],
  ...
  var o = e("base:widget/libs/jquerypacket.js"),
    ...
    a = {
      ...
      getPackName: function (e) {
        var t, n = s().tools.baseService.parseDirFromPath(e[0].path),
          o = e[0].isdir;
      ...
      ctrBrowserVersion: function (e, t, n) {
        var o = "get" + e.slice(0, 1).toUpperCase() + e.slice(1) + "Version",
          r = a[o],
          i = parseInt(r(), 10),
          n = parseInt(n, 10);
        ...
        this.useToast({
          ...
          t.useCloseToast(), e.promise.done(function () {
            e.passAPI.PassportInit.netdiskLogin({
              ...
              e.passAPI.PassportInit.hide(), s().log.send({
...
define("function-widget-1:download/service/dialogDownload.js", function (e, o, t) {
  function i() {
    y.dialog.isInitEvent || (y.dialog.isInitEvent = !0, n()), c.updateDialog(_, I), y.dialog.show()
  }
  ...
  function n() {
    ...
    e.delegate("#" + y._mPositiveId, "click", function () {
      y.dialog.hide(), "postInstall" === y.mode ? (d().log.send({
        page: u.getDownloadLogmsg(),
        type: I.logMsg.category + "-" + I.logMsg.actionDownloadClient
      }), c.updateMap.postInstall()) : (y.mode = "preInstall", I.state = y, s.start(_, I), d().log.send({
        page: u.getDownloadLogmsg(),
        type: I.logMsg.category + "-" + I.logMsg.actionAccelerateDownload,
        fileSize: u.getFileSizeType(I.list)
      }))
    }), e.delegate("#" + y._mPositiveId2, "click", function () {
      y.dialog.hide(), "postInstall" === y.mode ? (d().log.send({
        page: u.getDownloadLogmsg(),
        type: I.logMsg.category + "-" + I.logMsg.actionDownloadClient
      }), c.updateMap.postInstall()) : (y.mode = "preInstall", I.state = y, s.start(_, I), d().log.send({
      ...
      if (r("#" + y._mPositiveVideoId).attr("href").indexOf("javascript") > -1) {
        if ("share" === d().pageInfo.currentProduct && (!window.yunData || 1 !== Number(window.yunData.LOGINSTATUS))) return d().log.send({
          type: "download_share_login"
        }), window.yunHeader.login.util.loginNew(), window.yunHeader.on("loginSuccess", function () {
          w.setItem("shareAutoDownload", "1"), d().log.send({
            type: "download_share_login_success"
          })
        }), !1;
        g.start(_, I), d().log.send({
          page: u.getDownloadLogmsg(),
      ...
      d().log.send({
        ...
        page: u.getDownloadLogmsg(),
        type: I.logMsg.category + "-" + I.logMsg.actionDownloadClient
      }), c.updateMap.postInstall()) : (y.fromVideoCall = !0, I.state = y, s.start(_, I), d().log.send({
        page: u.getDownloadLogmsg(),
        type: I.logMsg.category + "-" + I.logMsg.actionAccelerateDownload,
        fileSize: u.getFileSizeType(I.list)
      }))
    }), e.delegate("#" + y._mNegativeVideoId, "click", function () {
      I.state = y, g.start(_, I), y.dialog.hide(), d().log.send({
        url: "//pan.baidu.com/api/analytics",
      ...
      y.dialog.hide(), d().log.send({
        url: "//pan.baidu.com/api/analytics",
        type: "video_download_guide_playclick_" + m[y.mode]
      })
      ...
      }), window.open(p.isSmallFlow("disk_index_jump_checkoutcounter") ? "//yun.baidu.com/buy/checkoutcounter?svip=1&tag=8&from=speedup#question=vip-speed" : "//yun.baidu.com/buy/center?tag=8&from=speedup#question=vip-speed"), !1
    })
  }
  ...
  function l(e) {
    var o = e,
      t = "";
    return t = o[a.INDEX_OF_FILENUM] !== a.FILE_NUM_SINGLE ? o[a.INDEX_OF_FILENUM] === a.FILE_NUM_MORE_100 || o[a.INDEX_OF_FILESIZE] === a.FILE_SIZE_MORE_LIMIT || o[a.INDEX_OF_ISDIR] === a.FILE_HASDIR ? "preInstall" : "preDownload" : o[a.INDEX_OF_ISDIR] === a.FILE_HASDIR ? "preInstall" : o[a.INDEX_OF_FILETYPE] === a.FILE_TYPE_CHROMEAPKEXE ? "preInstall" : o[a.INDEX_OF_FILESIZE] === a.FILE_SIZE_LESS_SMALL ? "directDownload" : o[a.INDEX_OF_FILESIZE] === a.File_SIZE_BETWEEN_SMALL_AND_LIMIT ? "preDownload" : "preInstall"
  }
  var a = e("function-widget-1:download/config.js"),
    d = e("function-widget-1:download/util/context.js").getContext,
    ...
    a = e("function-widget-1:download/config.js"),
    c = e("function-widget-1:download/util/interactionUtil.js"),
    r = (e("base:widget/libs/underscore.js"), e("base:widget/libs/jquerypacket.js")),
    p = e("base:widget/small-flow/small-flow-util.js"),
    u = e("function-widget-1:download/util/downloadCommonUtil.js"),
    w = e("base:widget/storage/storage.js"),
    _ = "",
    I = {},
    y = c.state,
    m = y.logMap;
  t.exports = {
    start: function (e, o) {
      I = o, _ = e, y.mode = l(e), y.fromVideoCall = !1, I.mode = y.mode, i()
    },
    initDialogEvent: function (e, o) {
      I = o, _ = e, y.dialog.isInitEvent || (y.dialog.isInitEvent = !0, n())
    }
  }
});;
define("function-widget-1:download/service/guanjiaDownloadController.js", function (i, n, a) {
  function e() {
    var i = T[f.INDEX_OF_PRODUCT],
      n = {};
    n[f.PRODUCT_SHARE] = y, n[f.PRODUCT_PAN] = t, n[f.PRODUCT_UNIONDIR] = o, U.ct = "pcygj", U.cv = E.guanjiaVersion, E.loadingTips = loadingTips = h().ui.tip({
      msg: "正在启动网盘客户端，请稍候...",
      mode: "loading",
      autoClose: !1
    }), n[i](), h().log.send({
  ...
  function t() {
    ...
    if (a.length > 0) {
      ...
      var l = U.list.every(function (i) {
          return !!i.needHidden
        }),
        s = {};
      l && (s.src = "xpan"), C.getDlinkPan(C.getFsidListData(U.list), "dlink", function (i) {
        0 === i.errno && (h().ui.hideTip(), n = p.getFormatedLinkList(n, i.dlink), g(n))
      }, "pcygj", E.guanjiaVersion, void 0, s)
    } else g(n)
  }

  function l() {
    if (E.guanjiaVersion = m.getVersion(), E.guanjiaVersion) e();
    else {
      if (0 === I("div.chromeUpgradeHelpTip", E.dialog.$dialog).length) {
        var i = I('<div class="chromeUpgradeHelpTip" style="text-align: center;position:relative;margin-bottom:10px;">已安装新版客户端，<a style="color:#09AAFF;" href="javascript:void(0);" class="local_retry">点此启动客户端开始下载</a>（已启动，<a style="color:#fc6258;text-decoration:underline;" href="/disk/help#FAQ18" target="_blank">仍无法下载？</a>）</div>');
        I("div.dlg-ft", E.dialog.$dialog).after(i), I("div.chromeUpgradeHelpTip a.local_retry").bind("click", function () {
          return c.openYunGuanjiaByScheme("baiduyunguanjia://guanjia/noui", function () {
            E.MAX_CHECK_COUNT = 7, E.checkCount = E.MAX_CHECK_COUNT, E.mode = "preInstall", v.updateDialog(f, U), l()
          }), !1
        })
      }
      E.checkCount > 0 ? (E.checkCount === E.MAX_CHECK_COUNT && (3 === E.MAX_CHECK_COUNT ? m.init() : m.init(!0), E.loadingTips = h().ui.tip({
        ...
        type: T[f.INDEX_OF_FILENUM] === f.FILE_NUM_SINGLE && T[f.INDEX_OF_FILESIZE] === f.FILE_SIZE_MORE_LIMIT ? "DownloadPluginDisplayForceHugeOptions" : "DownloadPluginDisplayForceNonhugeOptions"
      })
    }
  }
  ...
  function d(i, n) {
    var a, e, o = (E.guanjiaVersion, !1),
      t = T[f.INDEX_OF_PRODUCT],
      l = {};
    l[f.PRODUCT_SHARE] = function () {
      ...
      try {
        t && l ? (a = I.stringify({
          filelist: i
        }), e = m.callGuanjia(0 === yunData.SHARE_PUBLIC ? "DownloadPrivateShareItems" : "DownloadPublicShareItems", a)) : e = n ? m.callGuanjia("DownloadShareItems", n, yunData.MYUK, o) : 2, 0 > e && p.doError(e)
      } catch (s) {
        e = -2, p.doError(e)
      }
  ...
  function r(i, n) {
    ...
    if (o[f.PRODUCT_SHARE] = {
        ...
        checkuser: !0,
        filelist: n
      } : o[t], 0 === I("div.chromeUpgradeHelpTip", E.dialog.$dialog).length) {
      var l = I('<div class="chromeUpgradeHelpTip" style="text-align: center;position:relative;margin-bottom:10px;">已安装新版客户端，仍无法下载，<a style="color:#fc6258;" href="/disk/help#FAQ18" target="_blank">查看原因</a></div>');
      I("div.dlg-ft", E.dialog.$dialog).after(l)
    }
    D.sendServer(a, I.stringify(e), function (i) {
      if (i && 0 === i.errno) {
        E.loadingTips = h().ui.tip({
          msg: "正在启动网盘客户端，请稍候...",
          mode: "loading",
          autoClose: !1
        });
  ...
  var c = i("function-widget-1:download/util/downloadCommonUtil.js"),
    p = i("function-widget-1:download/util/downloadGuanjiaUtil.js"),
    f = i("function-widget-1:download/config.js"),
    ...
    v = i("function-widget-1:download/util/interactionUtil.js"),
    I = i("base:widget/libs/jquerypacket.js"),
    T = "",
    U = {},
    E = {
  ...
  a.exports = {
    start: function (i, n) {
      T = i, U = n, E.checkCount = E.MAX_CHECK_COUNT;
      for (var a in E) U.state ? U.state[a] = E[a] : v.state[a] = E[a];
      E = U.state ? U.state : v.state, E.mode = "preInstall", U.mode = E.mode, v.updateDialog(T, U), T[f.INDEX_OF_FILESIZE] === f.FILE_SIZE_MORE_LIMIT && h().log.send({
        page: c.getDownloadLogmsg(),
...
define("function-widget-1:download/service/downloadDirect.js", function (n, e, o) {
  ...
  function l(n) {
    ...
    var o = n.dlink.match(/(http|https):\/\/([^\/]*)\/.*/),
      t = o ? o[2] : "";
  ...
  function c(n, e) {
    ...
    k.getDlinkShare(t, function (n, e) {
      var t = "";
  ...
  function s(n, e) {
    var o = n.every(function (n) {
        return !!n.needHidden
      }),
      t = {};
    o && (t.src = "xpan"), k.getDlinkPan(k.getFsidListData(n), e, function (o) {
      "batch" === e ? I.dlink = o.dlink + "&zipname=" + encodeURIComponent(w.getPackName(n)) : "dlink" === e && (I.dlink = o.dlink[0].dlink), r(I)
    }, void 0, void 0, void 0, t)
  }

  function p(n, e) {
    D.isForBatch = "batch" === e, 1 === n.length ? k.getDlinkShare(D, function (n) {
      I.dlink = D.isForBatch ? n.dlink : n.list[0].dlink, r(I)
    }) : k.getDlinkShare(D, function (e) {
  ...
  function m(n) {
    ...
    y[3] === v.FILE_HASDLINK && r(I), y[3] === v.FILE_NODLINK && (y[4] === v.FILE_HASDIR ? _[e](n, "batch") : _[e](n, "dlink"))
  }
  ...
  var g = n("base:widget/libs/jquerypacket.js"),
    w = n("function-widget-1:download/util/downloadCommonUtil.js"),
    ...
    v = n("function-widget-1:download/config.js"),
    k = n("function-widget-1:download/service/dlinkService.js"),
    y = "",
    D = {},
    I = {},
    _ = {
      directDownloadInPan: s,
      directDownloadInShare: p,
      directDownloadInUniondir: c
    },
    b = {
      0: "Pan",
      1: "Share",
    ...
    F = "https://pcs.baidu.com/rest/2.0/pcs/file?method=batchdownload&app_id=250528",
    L = !1;
  o.exports = {
    start: function (n, e) {
      y = n, D = e;
      var o = D.list;
      y[2] === v.FILE_NUM_SINGLE && m(o), y[2] === v.FILE_NUM_MULTIPLE && u(o), t(o)
    }
  }
});;
define("function-widget-1:download/controller/downloadController.js", function (o, n, e) {
  ...
  function t(o, n) {
    ...
    for (var i = 0; i < o.length; i++)
      for (var t = 0; t < n.length; t++) e.push(o[i] + n[t]);
    return e
  }
  ...
  function d(o) {
    for (var n = 0; n < o.length; n++)
      if (o[n].isdir && 1 === o[n].isdir) return !0;
    return !1
  }
  ...
  var c = o("base:widget/libs/jquerypacket.js"),
    g = o("base:widget/libs/underscore.js"),
    ...
    E = o("function-widget-1:download/util/context.js").getContext,
    m = o("base:widget/storage/storage.js"),
    D = [],
    p = [],
    L = [],
    h = "";
  ...
  e.exports = {
    download: function (o) {
      ...
      var n = S.list,
        e = n.length,
        t = g.filter(n, function (o) {
          return 1 !== +o.isdir
        }).length,
        a = "";
      if (!n.length) return void E().ui.tip({
        mode: "caution",
        msg: "您还没有选择下载的文件"
      });
      ...
      S.logMsg = {
        ...
        if (a = s(S), a[0] === I.PLATFORM_WINDOWS ? E().log.send({
            type: "download_platform_windows"
          }) : (a[0] !== I.PLATFORM_MAC && (E().log.send({
            type: "mock_pf_" + navigator.platform
          }), E().log.send({
            type: "download_platform_others"
          })), E().log.send({
            type: "download_platform_mac"
          })), a[I.INDEX_OF_PRODUCT] !== I.PRODUCT_SHARE && "mpage" !== S.product_second && (S.isVideo = S.packName && 1 === S.list.length ? 1 === +S.list[0].category : !1), S.isNormalSingleFile = a[I.INDEX_OF_ISDIR] === I.FILE_NOTDIR && a[I.INDEX_OF_FILENUM] === I.FILE_NUM_SINGLE, D.indexOf(h) > -1) {
          if ("share" === E().pageInfo.currentProduct && (!window.yunData || 1 !== Number(window.yunData.LOGINSTATUS))) return E().log.send({
            type: "download_share_login"
          }), window.yunHeader.login.util.loginNew(), window.yunHeader.on("loginSuccess", function () {
            m.setItem("shareAutoDownload", "1"), E().log.send({
              type: "download_share_login_success"
            })
          }), !1;
          u.start(a, S)
        } else if (p.indexOf(a) > -1 && !S.isVideo) S.mode = "preInstall", _.initDialogEvent(a, S), f.start(a, S);
        else {
...
define("function-widget-1:download/service/dlinkService.js", function (t, e, r) {
  var a = t("base:widget/libs/jquerypacket.js"),
    ...
    n = t("function-widget-1:download/util/context.js").getContext,
    i = t("base:widget/vip/vip.js"),
    s = t("base:widget/tools/service/tools.cookie.js").getCookie,
    d = window.yunData,
    c = {
      PRODUCT_PAN: "pan",
      PRODUCT_MBOX: "mbox",
      ...
      _doError: function (t, e, r) {
        var a = "",
          o = this,
          i = n().accountBan(t);
        return i.isBan ? !1 : (2 == t && (a = "下载失败，请稍候重试"), 116 === t && (a = "该分享不存在！"), -1 === t && (a = "您下载的内容中包含违规信息！"), 118 === t && (a = "没有下载权限！"), (113 === t || 112 === t) && (a = '页面已过期，请<a href="javascript:window.location.reload();">刷新</a>后重试'), -20 === t ? void o._showVerifyDialog() : (121 === t && (a = "你选择操作的文件过多，减点试试吧。"), (31326 === t || 31426 === t) && (a = e ? decodeURIComponent(e) : "下载失败"), a = r || a, a = a || "网络错误，请稍候重试", void n().ui.tip({
          mode: "caution",
          msg: a,
          hasClose: !0,
          autoClose: !1
      ...
      getDlinkPan: function (t, e, r, o, s, c, u) {
        var p, l, g = this;
        if (null === g.sign) {
          try {
            l = new Function("return " + d.sign2)()
          } catch (h) {
            throw new Error(h.message)
          }
          if ("function" != typeof l) return void this._doError();
          g.sign = g.base64Encode(l(d.sign5, d.sign1))
        }
        "[object Array]" === Object.prototype.toString.call(t) ? t = a.stringify(t) : "string" != typeof t || /^\[\S+\]$/.test(t) || (t = "[" + t + "]"), p = {
          sign: g.sign,
          timestamp: d.timestamp,
          fidlist: t,
          type: e,
          vip: i.getVipValue()
        }, "object" == typeof u && Object.assign(p, u), o && s && (p.ct = o, p.cv = s), "cardHolder" === n().router.currentRouteName && (p.src = "cardholder"), a.ajax({
          ...
          success: function (t, e, o) {
            ...
            }), 0 == t.errno ? t.dlink && t.dlink.length > 0 ? "function" == typeof r && (t.logType = "webdownload", t.logFrom = p.type, r(t)) : g._doError() : g._doError(t.errno, t.errmsg, t.show_msg)
          },
          error: function (t, e) {
            n().log.send({
              type: "webdownload",
      ...
      ajaxGetDlinkShare: function () {
        ...
        0 === d.SHARE_PUBLIC && (t.extra = a.stringify({
          sekey: decodeURIComponent(s("BDCLND"))
        }));
        var e = function () {
        ...
        return function (r, o) {
          ...
          delete d.sign, delete d.timestamp, d.vip = i.getVipValue(), a.ajax({
            ...
            success: function (t, r, i) {
              ...
              }), t ? void(0 == t.errno ? (d.product === s.PRODUCT_SHARE && e(), "function" == typeof o && (t.logType = "websharedownload", t.logFrom = d.product, o(t))) : s._doError(t.errno, t.errmsg, t.show_msg)) : void s._doError()
            },
            error: function (t, e) {
              n().log.send({
                type: "websharedownload",
